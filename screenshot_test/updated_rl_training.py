...
FRAME_STACK   = 4
CNN_SIZE      = (84, 84)
ACTIONS       = [ "kick", "transform", "jump", "squat", "left", "right"]
...
LOAD_CHECKPOINT = "C:/Users/richa/bro2_rl/screenshot_test/model_match_706.pth"  # Set to None to train from scratch
